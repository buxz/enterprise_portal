...
<%@ page import="com.buxz.enterprise_portal.entity.Function" %>
...
<%
    ...
    if (Action != null && Action.equals("Edit"))//判断是否存在
    {
        ...
        {
            out.println("<script>alert('修改新闻成功!');location.href='/admin/news';</script>");//页面输出
            return;//结束
        } else //否则
        {
            out.println("<script>alert('修改新闻失败!');location.href='/admin/news';</script>");//页面输出
            return;//结束
        }
    }
